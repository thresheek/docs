...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/busybox/badge/icon) (`amd64/busybox` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/busybox/)
