...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/perl/badge/icon) (`ppc64le/perl` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/perl/)
