...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/pypy/badge/icon) (`ppc64le/pypy` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/pypy/)
