...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/joomla/badge/icon) (`i386/joomla` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/joomla/)
