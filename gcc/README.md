...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/gcc/badge/icon) (`ppc64le/gcc` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/gcc/)
