...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/mysql/badge/icon) (`amd64/mysql` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/mysql/)
