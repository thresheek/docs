...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/solr/badge/icon) (`amd64/solr` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/solr/)
