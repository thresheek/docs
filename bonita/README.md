...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/bonita/badge/icon) (`ppc64le/bonita` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/bonita/)
...
-	Launch the new container pointing towards the copy of DB and filesystem
	...
	```console
	$ docker run --name=bonita_7.8.4_postgres --link mydbpostgres:postgres -e "DB_NAME=newbonitadb" -e "DB_USER=newbonitauser" -e "DB_PASS=newbonitapass" -d -p 8081:8080 ppc64le/bonita:7.8.4
	```
